...
"""
TabTitle='*'                                    # The title that the tab will have in your Browser.
TitleText='startpage'                       # The title that the window will have. 
...
hourOffset=9                                           # Apply permanent offset to clock. For more information look into readme.
